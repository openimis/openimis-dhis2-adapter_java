...
public class ParamsUtil {
    ...
    public static String CLAIM_PAGE_SIZE = "_count=250";
    public static String LOCATION_PAGE_SIZE = "_count=250";
    public static String COVERAGE_PAGE_SIZE = "_count=250";
    public static String PATIENT_PAGE_SIZE = "_count=250";
    ...
    public static String ORG_UNITS_ROOT_CODE="root";
    public static String ORG_UNITS_ATT_LOCID_CODE="gMNNTAdZbW1";
    public static String ORG_UNITS_ATT_TYPE_CODE="ffZOxd5V2UK";
}
